...
export const config: AppConfig = {
  apiUrl: process.env.EXPO_PUBLIC_API_URL || 'http://192.168.31.194:3001/api',
  blockchainNetwork: process.env.EXPO_PUBLIC_BLOCKCHAIN_NETWORK || '192.168.31.194',
  appVersion: '1.0.0',
...
export const blockchainConfig = {
  ...
  rpcUrl: process.env.EXPO_PUBLIC_RPC_URL || 'http://192.168.31.194:8545',
